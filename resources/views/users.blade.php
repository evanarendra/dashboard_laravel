...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('templates/adminLTE/dist/css/adminlte.min.css?v=3.2.0') }}">
    <script nonce="2d5358df-2315-4940-9178-023b830dc4f1">
        (function(w, d) {
            ! function(a, b, c, d) {
                a[c] = a[c] || {};
                a[c].executed = [];
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            ...
                            <div class="media">
                                <img src="{{ asset('templates/adminLTE/dist/img/user1-128x128.jpg') }}"
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('templates/adminLTE/dist/img/user2-160x160.jpg') }}"
